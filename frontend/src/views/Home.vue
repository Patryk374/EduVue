<template>
  <div class="animate-fade-in">
    <!-- Hero Section -->
    <section class="w-full bg-[var(--accent-color)] text-white py-16 sm:py-24 transition-colors duration-300">
      <div class="w-full px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center">
          ...
          <router-link
              :to="{ name: 'Courses' }"
              class="inline-block bg-white dark:bg-gray-800 
         text-[var(--accent-color)] dark:text-white
         hover:brightness-110 px-8 py-3 rounded-lg font-semibold transition-colors duration-300"
          >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div class="relative h-48">
                ...
                />
                <div class="absolute top-4 right-4 bg-white dark:bg-gray-800 px-3 py-1 rounded-full text-sm font-medium text-[var(--accent-color)] transition-colors duration-300">
                  {{ course.level }}
                </div>
              </div>
              <div class="p-6">
